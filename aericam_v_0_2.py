...
photo_button_img = load_image(r'images\photo_button.png', 32)
start_recording_img = load_image(r'images\video_button.png', 32)
stop_recording_img = load_image(r'images\stop_button.png', 32)
pause_button_img = load_image(r'images\pause_button.png', 32)
resume_button_img = load_image(r'images\resume_button.png', 32)
gallery_button_img = load_image(r'images\gallery_button.png', 32)
