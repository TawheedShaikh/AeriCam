...
def draw_radar(frame, roll_value):
    ...
    angle_difference = (target_angle - last_angle + 180) % 360 - 180  # Wrap to [-180, 180]

    # Smooth transition
    last_angle += angle_difference * 0.1  # Adjust the smoothing factor here if necessary
    last_angle %= 360  # Ensure last_angle stays within 0-360

    # Calculate the radar line endpoint
    angle_rad = math.radians(last_angle)
    ...
    cv2.line(frame, (center[0], center[1] - min_radius), (center[0], center[1] + min_radius), (255, 255, 255),
             1)  # Vertical line
    cv2.line(frame, (center[0] - min_radius, center[1]), (center[0] + min_radius, center[1]), (255, 255, 255),
             1)  # Horizontal line
...
# Global variables to store last roll value and last radar angle
last_roll_value = "0"
last_angle = 0
...
photo_button_img = load_image(r'C:\Users\DELL\PycharmProjects\AeriCam\photo_button.png', 48)
start_recording_img = load_image(r'C:\Users\DELL\PycharmProjects\AeriCam\video_button.png', 48)
stop_recording_img = load_image(r'C:\Users\DELL\PycharmProjects\AeriCam\stop_button.png', 48)
pause_button_img = load_image(r'C:\Users\DELL\PycharmProjects\AeriCam\pause_button.png', 48)
resume_button_img = load_image(r'C:\Users\DELL\PycharmProjects\AeriCam\resume_button.png', 48)
gallery_button_img = load_image(r'C:\Users\DELL\PycharmProjects\AeriCam\gallery_button.png', 48)  # Load gallery button image
